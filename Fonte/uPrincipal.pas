...
begin
  ...
  begin
    try
      ...
      pMsgAtencao('Não foi possível conectar à base! Verifique as configurações ' + #13 +
...
begin
  Self.Caption := 'SAGE - Sistema de Automação e Gerenciamento de Empresas [Versão: ' + lbVersao.InfoString + ']';
end;
...
begin
  try
    ...
    try
      ...
      on E: Exception do
      begin
        pMsgAtencao('Não foi possível carregar o parâmetro!' + #13 + 'Verifique os detalhes do erro e contate o suporte para transmitir o problema.',
